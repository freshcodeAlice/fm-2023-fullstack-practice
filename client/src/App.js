...
/*
Завдання:
1. Подружити MessageArea і DragNDrop, щоби можна було обирати файли
2. Виправити на беку приймання файлів
3. Змінити api, щоби файли надсилались (Content-Type)
4. Протестити - відправити картинку
5. Перевірити, що картинка зберіглась як повідомлення
6. Реалізувати на фронті підтягування картинки-як-повідомлення
